const sendDiscordReminderEmail = async ({ email }) => {
            ...
            <tr>
               <td align="center">
                  <div class="container">
                     ...
                     <p style="text-align:left">
                        Please remember to <b>join our Discord server <a href="https://discord.gg/jduNFuwKuk">for Cutie Hack 2022</a></b> if you haven't already. 
                     </p>
                     <p style="text-align:left">
                       Discord will be our <b>main platform</b> of communication for online participants and announcements.
                     </p>
                     <p style="text-align:left">
                        The Cutie Hack Team
                     </p>
  ...
  const msg = {
    ...
    subject: "Cutie Hack: Join Our Discord Server!",
    html: email_content,
  };
...
export { sendDiscordReminderEmail };
