const sendCheckInReminderEmail = async ({ email }) => {
                ...
                <tr>
                   <td align="center">
                      <div class="container">
                         ...
                         <p style="text-align:left">
                            <b>Check-in forms are now open!</b> Be sure to check in <a href="https://cutiehack.io">at our website</a> (be sure to sign-in first) to confirm your participation in Cutie Hack 2022.
                         </p>
                         <p style="text-align:left">
                            We look forward to everyone's participation and can't wait to see all your amazing ideas come to life!
                         </p>
                         <p style="text-align:left">
                            The Cutie Hack Team
                         </p>
  ...
  const msg = {
    ...
    subject: "[IMPORTANT] Citrus Hack: Check-in Forms Are Open!",
    html: email_content,
  };
...
export { sendCheckInReminderEmail };
