const sendReReviewEmail = async ({ email, first_name }) => {
                  ...
                  <tr>
                     <td align="center">
                        <div class="container">
                           ...
                           <p style="text-align:left">
                              We've got good news, ${first_name}! Upon re-review your application to participate in Cutie Hack 2022 has been accepted!
                           </p>
                           <p style="text-align:left">
                              Stay tuned for more updates from us via email. 
                           </p>
                           <p style="text-align:left">
                           In the meantime, <a href="https://discord.gg/jduNFuwKuk">join our Discord Server</a>, the main platform that we will use on the day of the hackathon. Please don't share this invite with anyone else who wasn't approved. Thank you!
                           </p>
                           <p style="text-align:left">
                              The Cutie Hack Team
                           </p>
  ...
  const msg = {
    ...
    subject: "Cutie Hack: Your Application Status",
    html: email_content,
  };
