...
export function SearchBar({
  ...
  return (
    <div className="w-full mb-3">
      <div className="w-full flex items-center pl-2 border-2 border-sub-highlight rounded-md bg-secondary">
        <div>
          <BiSearch className="text-2xl" />
        </div>
        <input
          className="w-full ml-2 py-2 outline-0 rounded-tr-md rounded-br-md bg-secondary"
          value={searchFilter}
