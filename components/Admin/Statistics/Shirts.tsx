  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-rows-7 gap-4 rounded-2xl">
        <StatsBlob num={numXXS} numTotal={numTotal} label="XXS Shirts" />
        <StatsBlob num={numXS} numTotal={numTotal} label="XS Shirts" />
        <StatsBlob num={numS} numTotal={numTotal} label="S Shirts" />
        <StatsBlob num={numM} numTotal={numTotal} label="M Shirts" />
        <StatsBlob num={numL} numTotal={numTotal} label="L Shirts" />
        <StatsBlob num={numXL} numTotal={numTotal} label="XL Shirts" />
