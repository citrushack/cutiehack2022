...
export default function Landing() {
  ...
  return (
    <>
      <section className="flex w-full h-screen justify-center items-center my-10 min-h-[48rem] md:min-h-[60rem] xl:max-w-[68rem] 2xl:max-w-[80rem] lg:my-0 mb-20 md:mb-0 gap-6">
