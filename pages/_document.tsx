    ...
    return (
      <Html lang="en" className="m-0 p-0 box-border overflow-x-hidden">
        <Head>
          ...
          <link rel="preload" as="image" href="/assets/desktopLamps.svg" />
          <link rel="preload" as="image" href="/assets/desktopLampsBlur.png" />
          ...
          <link rel="preload" as="image" href="/assets/mountains2.svg" />
          ...
          <link rel="preload" as="image" href="/assets/staffLineLeft.svg" />
          <link rel="preload" as="image" href="/assets/staffLineRight.svg" />
        </Head>
